    ...
    <Card.Group>
      <Card>
        <Card.Content>
          ...
          <Card.Meta>
            <b>hint:</b> zero vertical strokes
          </Card.Meta>
          <Divider />
      ...
      <Card>
        <Card.Content>
          ...
          <Card.Meta>
            <b>hint:</b> three vertical strokes
          </Card.Meta>
          <Divider />
      ...
      <Card>
        <Card.Content>
          ...
          <Card.Meta>
            <b>hint:</b> L is the Roman numeral for 50
          </Card.Meta>
          <Divider />
      ...
      <Card>
        <Card.Content>
          ...
          <Card.Meta>
            <b>hint:</b> looks like flipped g
          </Card.Meta>
          <Divider />
          <Card.Content>
            ch (in cheese and chef), j, soft g, sh, c (in cello and special), cz
            (in Czech), s (in tissue and vision), sc (in fascist), sch (in schwa
            and eschew), t (in ration and equation), tsch (in putsch), z (in
            seizure)
          </Card.Content>
        </Card.Content>
      </Card>
      <Card>
        <Card.Content>
          ...
          <Card.Meta>
            <b>hint:</b> k look like two small 7s on their sides
          </Card.Meta>
          <Divider />
      ...
      <Card>
        <Card.Content>
          ...
          <Card.Meta>
            <b>hint:</b> p looks like 9 flipped horizontally, b looks like the 9
            turned 180°
          </Card.Meta>
          <Divider />
